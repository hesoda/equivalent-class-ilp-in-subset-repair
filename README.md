...
```
python3 driver.py --input_dir ../data/example/ --result_dir ../result/example/ --relation example_relation.csv --fdset example_fdset.txt --rc example_rc.txt --solvers vc_approx_baseline,ilp_baseline
...
python3 driver.py --input_dir ../data/input_data_compas/non_chain_FD/ --result_dir ../result/compas_nonchain_30k/ --relation 30000_0.05_dirty.csv --fdset non_chain_fdset.txt --rc SEX_rc.txt --solvers vc_approx_baseline,equiv_class_ilp,fdcleanser,lhschain_dp
```
